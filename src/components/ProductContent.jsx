      ...
      <div className={classes.productContent}>
        ...
        <div className={classes.rightSide}>
          ...
          <p className={classes.text}>
            ...
            Perspiciatis cum explicabo veniam maxime earum sunt praesentium
            debitis optio eaque deleniti! Quia aspernatur minima illo
            laboriosam.
          </p>
            ...
            <div className={classes.colors}>
              {colors.map((color, index) => (
                <div
                  key={index}
                  className={
                    index == productColor ? classes.activeColor : classes.color
                  }
            ...
            <div className={classes.sizes}>
              {sizes.map((size, index) => (
                <div
                  key={index}
                  className={
                    index == productSize ? classes.activeSize : classes.size
                  }
          ...
          <div className={classes.userInput}>
            ...
            <button
              ...
              onClick={() => addToCart(title, price, itemCount)}
            >
              ADD TO CART <ImArrowUpRight2 color="white" size={`20px`} />
            </button>
          </div>
        </div>
      </div>
